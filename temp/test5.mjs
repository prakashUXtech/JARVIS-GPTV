...
//   y: [5, 1, 7, 5]
// };
// const line = grid.set(0, 0, 4, 4, contrib.line, { 
//   showNthLabel: 5,
//   maxY: 10,
//   label: 'Title',
//   showLegend: true,
...
// };
// const table = grid.set(0, 4, 4, 4, contrib.table, {
//   keys: true,
//   fg: 'white',
//   selectedFg: 'white',
//   selectedBg: 'blue',
...
// const map = grid.set(4, 4, 4, 4, contrib.map, { label: 'World Map' });
// map.addMarker({ "lon": "77.23", "lat": "28.61", color: "red", char: "X" });

// // Allow for screen exit on 'q' or 'C-c'
